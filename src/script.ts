...
const greetingText = document.getElementById("Que") as HTMLElement;
const sendBtn = document.getElementById("Send") as HTMLButtonElement;
const inputElem = document.getElementById("input") as HTMLTextAreaElement;
const titleWrapper = document.getElementById("Title-wrapper") as HTMLElement;
...
function renderRecents(filterText: string = ""): void {
...
function loadChatIntoUI(id: string): void {
...
function appendZeroMessage(text: string): void {
...
function handleSendMessage(): void {
  ...
  if (
    ...
    lowerText.includes("code") || lowerText.includes("program") ||
    ...
    lowerText.includes("who are you") || lowerText.includes("your name") ||
    ...
    lowerText.includes("zoro") || lowerText.includes("temitope") ||
    ...
    lowerText.includes("how are you") || lowerText.includes("how far") ||
    ...
    lowerText.includes("bye") || lowerText.includes("goodnight") ||
